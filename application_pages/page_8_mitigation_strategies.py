...
from utils import add_mitigation_strategy, go_to_page # Import the navigation helper
...
def main():
    ...
    with col1:
        if st.button("Previous Step", key="page8_prev_btn"):
            go_to_page(6) # Navigate to "AI Risk Matrix Visualization"
    with col2:
        if st.button("Next: Generate Final Report", key="page8_next_btn"):
