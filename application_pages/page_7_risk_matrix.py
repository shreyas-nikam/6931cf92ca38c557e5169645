...
def main():
    ...
    with col1:
        if st.button("Previous Step", key="page7_prev_btn"):
            go_to_page(5) # Navigate to "AI Risk Register: Assess Risk Severity"
    with col2:
        if st.button("Next: Develop Mitigation Strategies", key="page7_next_btn"):
            go_to_page(7) # Navigate to "AI Risk Register: Mitigation Strategies"
