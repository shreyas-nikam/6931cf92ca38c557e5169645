...
def main():
    ...
    st.markdown("---
    As a Quantitative Analyst, before diving into risk identification, you need to thoroughly understand the AI model itself. This involves grasping its fundamental purpose, the algorithm it uses, and its intended operational environment. For the new Credit Risk Scoring Model, you've gathered initial details from the development team. This foundational understanding is the first step in applying frameworks like SR 11-7 and NIST AI RMF, ensuring you assess the right "model" in its specific context.
    ")
    ...
    with col1:
        if st.button("Previous Step", key="page2_prev_btn"):
            go_to_page(0) # Navigate to "Welcome & Scenario Setup"
    with col2:
        if st.button("Next: Data Card", key="page2_next_btn"):
